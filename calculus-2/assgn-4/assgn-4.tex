            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    \item Functions of the form $a_1x^{b_1} + ... + a_nx^{b_n}$ are
                        only odd when $b_i \in 2\mathbb{N} + 1$ and even when $b_i \in
                        ...
                        oddness. So yes, if $f$ and $g$ are of the forms
                        described above then $f'$ is odd and $g'$ is even.
                \end{enumerate}
                \item
                    \begin{enumerate}
            ...
            \item
                \begin{enumerate}
                    \item 
                        \begin{align*}
                            \ddot{x} &= t^2 + bt + c \\
                            \dot{x} &= \frac{t^3}{3} + b\frac{t^2}{2} + c \\
                \end{enumerate}
            \item
                \begin{align*}
                    \dydx &= 3xy \\
                ...
                \begin{align*}
                    ...
                    y_{i+1} &= y_i + 0.1\cdot 3x_iy_i + \frac{h^2}{2!}\df{^2y}{x^2} + \frac{h^3}{3!}\df{^3y}{x^3}
                \end{align*}
    \end{enumerate}
\end{document}
